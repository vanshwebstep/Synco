    ...
    return (
        <CommunicationContext.Provider
            value={{// Free Trials
                ...
                fetchCommunicationTemplate,apiTemplates, setApiTemplates,createTemplateCategories, createCommunicationTemplate,deleteCommunicationTemplate,updateCommunicationTemplate
            }}>
            {children}
        </CommunicationContext.Provider>
    );

                                        ...
                                        >
                                            ...
                                            <div className="flex items-center mt-4 md:mt-0 gap-4">
                                                ...
                                                <button onClick={() => toggleSessions(index)} className="ml-4 flex font-semibold items-center gap-2 whitespace-nowrap px-4 pr-6 py-2 border rounded-xl text-[16px] font-medium text-[#237FEA] border-blue-500 hover:bg-blue-50">
                                                    {openClassIndex === index ? 'Hide sessions' : 'View sessions'}  <img src="/demo/synco/images/icons/bluearrowup.png" className={`${openClassIndex === index ? '' : 'rotate-180'} transition-transform`} alt="" />
                                                </button>
                                            </div>
                                                                    ...
                                                                    <div key={term.id}>
                                                                        ...
                                                                        >
                                                                            ...
                                                                            <div className='flex mb-4 items-center gap-8 justify-start'>
                                                                                <div><img src="/demo/synco/images/icons/blackarrowup.png" className={`${openTerms[term.id] ? "" : "rotate-180"} transition-transform`} alt="" /></div>
                                                                                            ...
                                                                                            <div className="flex items-center gap-2 text-sm">
                                                                                                <span className="rounded-full flex items-center gap-2 font-medium capitalize text-[15px] md:min-w-[120px]">
                                                                                                    {session?.sessionPlan?.status === "pending" && (
                                                                                                        <img src="/demo/synco/images/icons/pending.png" className="w-4 h-4" alt="Pending" />
                                                                                                    )}
                                                                                                    {session?.sessionPlan?.status === "completed" && (
                                                                                                        <img src="/demo/synco/images/icons/complete.png" className="w-4 h-4" alt="Complete" />
                                                                                                    )}
                                                                                                    {session?.sessionPlan?.status === "cancelled" && (
                                                                                                        <img src="/demo/synco/images/icons/cancel.png" className="w-4 h-4" alt="Cancelled" />
                                                                                                    )}
                                                                                                    {session?.sessionPlan?.status || (
                                                                                                        <>
                                                                                                            <img src="/demo/synco/images/icons/pending.png" className="w-4 h-4 inline" alt="Pending" /> Pending
                                                                                                        </>
                                                                                                    )}
                                                                                                </span>
                                                                                            </div>
                        ...
                        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
                            <div className="bg-white rounded-3xl w-[90%] md:w-[900px] p-6 relative shadow-xl">
                                <div className="flex justify-between items-center mb-6">
                                    ...
                                    >
                                        <img src="/demo/synco/images/icons/cross.png" alt="" />
                                    </button>
                                </div>

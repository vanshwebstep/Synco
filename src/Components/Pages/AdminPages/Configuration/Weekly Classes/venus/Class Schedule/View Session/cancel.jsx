  ...
  return (
    <div className="p-4 md:p-6 bg-gray-50 min-h-screen">
      <div className="flex justify-between items-start md:items-center mb-6">
        <h2
          onClick={() => navigate('/configuration/weekly-classes/venues/class-schedule')}
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2 text-sm">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <label><input type="radio" checked={!creditSession} onChange={() => setCreditSession(false)} /> No</label>
        </div>
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <label><input type="radio" checked={!notifyTrials} onChange={() => setNotifyTrials(false)} /> No</label>
        </div>
    ...
    <div className="space-y-4">
      <div className="flex flex-wrap p-1 rounded-xl mb-4 w-fit">
        {tabs.map(tab => (
          <button
            ...
            className={`px-4 py-1.5 border-b text-sm md:text-base min-w-24 font-medium transition ${
              activeTab === tab ? 'border-blue-500' : 'text-gray-500 border-b border-gray-200 hover:text-blue-500'
            }`}
          >
            {tab}
          </button>
      ...
      <div className="space-y-3">
        ...
        <label className="block text-sm md:text-base font-semibold mt-2">Email</label>
        <textarea
        ...
        <div className="text-end">
          <button className="mt-4 w-full md:w-auto bg-blue-500 text-white text-sm md:text-base px-6 py-3 md:px-20 rounded-lg hover:bg-blue-600">
            Send
          </button>
        </div>
      </div>

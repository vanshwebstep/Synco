      ...
      <div className="flex flex-col md:flex-row justify-between p-4 gap-4 text-sm">
        ...
        <div className='grid md:w-7/12 md:grid-cols-3'>
          ...
          <div className="flex items-center gap-3">
            <img src='/demo/synco/images/icons/spring.png' alt='' className="w-8 mt-1 flex-shrink-0" />
            <div>
          ...
          <div className="flex items-center gap-3">
            <img src='/demo/synco/images/icons/autumn.png' alt='' className="w-8 mt-1 flex-shrink-0" />
            <div>
          ...
          <div className="flex items-center gap-3">
            <img src='/demo/synco/images/icons/summer.png' alt='' className="w-8 mt-1 flex-shrink-0" />
            <div>

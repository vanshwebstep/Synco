 ...
 <div className="w-full bg-white rounded-2xl border border-[#D9D9D9] shadow-sm relative p-2">
  ...
  <div className="bg-[#2E2F3E] text-white p-4 rounded-xl flex justify-between md:items-center text-sm gap-4">
    ...
    <div className="md:mt-0 mt-5 flex relative items-center gap-4">
      <img src="/demo/synco/icons/fcDollar.png" alt="" className="cursor-pointer w-6 h-6 rounded-full bg-white" />
      <img src="/demo/synco/icons/fcCalendar.png" alt="" className="cursor-pointer w-6 h-6 rounded-full bg-white" />
      <img src="/demo/synco/icons/fcLocation.png" alt="" className="cursor-pointer w-6 h-6 rounded-full bg-white" />
      <img src="/demo/synco/icons/fcCicon.png" alt="" className="cursor-pointer w-6 h-6 rounded-full bg-white" />
      <img src="/demo/synco/icons/fcPIcon.png" alt="" className="cursor-pointer w-6 h-6 rounded-full bg-white" />
    </div>
  </div>
